  ...
  return (
    <div className="min-h-screen page-shell">
      ...
      <main className="ml-0 md:ml-64 p-6 md:p-12 min-h-screen max-w-[1024px]">
        ...
        {/* Tab Selector Header */}
        <div className="border-b border-[#e2e6ee] flex gap-6 mb-6">
          <button
        ...
        {activeTab === 'umum' && (
          <div className="bg-white border border-[#e2e6ee] rounded-2xl p-6 shadow-sm">
            <form onSubmit={handleSaveUmum} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  className="w-full px-3 py-2 bg-[#f4f6fb] border border-[#e2e6ee] rounded-lg text-[#5c6268] cursor-not-allowed text-xs"
