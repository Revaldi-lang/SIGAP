            ...
            <div className="bg-white border border-[#D3C5B1] rounded-2xl p-6 shadow-sm">
              <form onSubmit={handleSaveUmum} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-[#4E4639] uppercase tracking-wider mb-2">NIP / NIK</label>
                    <input
                      type="text"
                      value="199408122020121002"
                      disabled
                      className="w-full px-3 py-2 bg-[#F6F3EC] border border-[#D3C5B1] rounded-lg text-[#807667] font-mono cursor-not-allowed text-xs"
                      title="NIP resmi tidak dapat diubah secara mandiri"
                    />
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-[#4E4639] uppercase tracking-wider mb-2">Nomor Telepon / WA</label>
                    <input
                      type="text"
                      required
                      value={telepon}
