      ...
      <div className="min-h-screen page-shell flex flex-col">
        ...
        <main className="ml-0 md:ml-64 p-6 md:p-10 min-h-screen flex flex-col">
          ...
          <header className="flex items-center gap-3 mb-6 shrink-0">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-[#001360] mb-0.5">Peta Spasial Dampak Kerusakan</h1>
              <p className="text-sm text-[#807667]">Halaman pemantauan visual geografis titik kerusakan infrastruktur wilayah secara real-time.</p>
            </div>
          </header>

          {/* Filter Map Panel */}
          <section className="page-card p-5 rounded-2xl mb-6 flex flex-wrap gap-6 items-center shrink-0">
            <span className="text-xs font-semibold uppercase tracking-wider text-[#807667]">Filter Status:</span>
