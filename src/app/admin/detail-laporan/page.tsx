  ...
  if (!aduan) {
    return (
      <div className="min-h-screen bg-[#FEFDF8] flex flex-col items-center justify-center p-6 text-center">
        ...
        <Link href="/admin/laporan" className="bg-[#001360] text-white px-6 py-3 rounded-xl text-xs font-bold shadow-md hover:opacity-90 active:scale-95 transition-all">
      ...
      <div className="min-h-screen page-shell">
        ...
        <main className="ml-0 md:ml-64 p-6 md:p-10 min-h-screen">
          ...
          <header className="flex justify-between items-start md:items-center flex-col md:flex-row gap-4 mb-10">
            ...
            <div>
              <span className={"inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-bold border uppercase tracking-wider " + getStatusBadgeClass(aduan.status)}>
